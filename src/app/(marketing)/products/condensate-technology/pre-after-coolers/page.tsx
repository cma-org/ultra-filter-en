...
const sub = condensateTechnology.subcategories.find(s => s.slug === 'pre-after-coolers')!;
          ...
          <div className="flex-1 min-w-0">
            ...
            <section className="border border-[#d7d7d7] bg-white">
              <div className="border-b border-[#1f4567]/30 bg-[#0a4c79] px-3 py-1.5 text-sm font-medium text-white">
                Pre- and aftercoolers
              </div>
              <div className="p-4">
                <h3 className="mb-2 text-[24px] font-bold uppercase tracking-[0.3em] text-[#123f66]">ULTRA.COOLER UAW / UAL</h3>
                <ul className="list-disc space-y-2 pl-5 text-[13px] leading-7 text-[#3f3f3f] marker:text-[#0a4c79]">
                  <li>Water Cooled Chillers UAW</li>
                  <li>Air Cooled Chillers UAL</li>
                </ul>
              </div>
            </section>

            <div className="mt-8 text-right">
              <a href="/products/condensate-technology/pre-after-coolers" className="text-sm font-semibold text-[#123f66] hover:text-[#e87722]">
                Printable version
              </a>
            </div>
          </div>
