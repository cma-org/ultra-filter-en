...
const sub = measurementTechnology.subcategories.find(s => s.slug === 'consumption')!;
          ...
          <div className="flex-1 min-w-0">
            ...
            <section className="border border-[#d7d7d7] bg-white">
              <div className="border-b border-[#1f4567]/30 bg-[#0a4c79] px-3 py-1.5 text-sm font-medium text-white">
                Flow measurement in compressed air and gases
              </div>
              <div className="grid grid-cols-1 gap-8 p-4 md:grid-cols-[1fr_220px]">
                <div className="space-y-4 text-[13px] leading-7 text-[#3f3f3f]">
                  <p>
                    Ultrafilter offers convenient and high-quality thermal mass flow meters for consumption
            ...
            <section className="mt-6 px-4">
              <ul className="list-disc space-y-2 pl-5 text-[13px] leading-7 text-[#3f3f3f] marker:text-[#0a4c79]">
                <li>Compressed air generation and distribution</li>
                <li>Distribution of process gases such as carbon dioxide, argon, nitrogen, oxygen</li>
                <li>Explosive gases such as natural gas, hydrogen, biogas</li>
                <li>Corrosive gases such as biogas</li>
                <li>Fuel and air supply to burners, boilers and industrial furnaces</li>
                <li>Airflow in chillers</li>
                <li>Metering and gas injection control</li>
              </ul>
            </section>
